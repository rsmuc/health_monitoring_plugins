...
import os
import sys
sys.path.insert(0, os.path.abspath('health_monitoring_plugins/check_ubiquiti'))
...
def test_list_flag():
  p = subprocess.Popen("health_monitoring_plugins/check_ubiquiti/check_ubiquiti.py -l", shell=True, stdout=subprocess.PIPE, stderr=subprocess.STDOUT)
  list_output =""
...
def test_ubiquiti_basics1():
  ...
  #without options
  p = subprocess.Popen("health_monitoring_plugins/check_ubiquiti/check_ubiquiti.py", shell=True, stdout=subprocess.PIPE, stderr=subprocess.STDOUT)
  myout =  p.stdout.read()
  print "--------------------"
  print myout
  ...
  p = subprocess.Popen("health_monitoring_plugins/check_ubiquiti/check_ubiquiti.py -H 1.2.3.4", shell=True, stdout=subprocess.PIPE, stderr=subprocess.STDOUT)
...
def test_ubiquiti_ok_outputs():
  for n,u in zip(names,units):
    p = subprocess.Popen("health_monitoring_plugins/check_ubiquiti/check_ubiquiti.py -H 127.0.0.1:1234 -t "+n +" --th metric=type,warning=:10,critical=:20", shell=True, stdout=subprocess.PIPE, stderr=subprocess.STDOUT)
