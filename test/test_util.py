...
def check_within_range(
    ...
    warning_thres, critical_thres = build_threshold_range_strings(the_expected_value+1)
    p=subprocess.Popen(
        the_plugin_path
    ...
    warning_thres, critical_thres = build_threshold_range_strings(the_expected_value+2)
    p=subprocess.Popen(
        the_plugin_path
        + " -H localhost:1234 -t '" + the_check_type + "'"
        + " -c " + critical_thres 
    ...
    warning_thres, critical_thres = build_threshold_range_strings(the_expected_value-3)
    p=subprocess.Popen(
        the_plugin_path
        + " -H localhost:1234 -t '" + the_check_type + "'"
        + " -c " + critical_thres 
...
def check_below_threshold(
    ...
    warning_thres, critical_thres = build_threshold_alert_low_strings(the_expected_value+1)
    p=subprocess.Popen(
        the_plugin_path
        + " -H localhost:1234 -t '" + the_check_type + "'"
        + " -c " + critical_thres 
    ...
    warning_thres, critical_thres = build_threshold_alert_low_strings(the_expected_value+2)
    p=subprocess.Popen(
        the_plugin_path
        + " -H localhost:1234 -t '" + the_check_type + "'"
        + " -c " + critical_thres 
    ...
    warning_thres, critical_thres = build_threshold_alert_low_strings(the_expected_value+3)
    p=subprocess.Popen(
        the_plugin_path
        + " -H localhost:1234 -t '" + the_check_type + "'"
        + " -c " + critical_thres 
...
def check_above_threshold(
    ...
    warning_thres, critical_thres = build_threshold_alert_above_strings(the_expected_value-2)
    p=subprocess.Popen(
        the_plugin_path
        + " -H localhost:1234 -t '" + the_check_type + "'"
        + " -c " + critical_thres 
    ...
    warning_thres, critical_thres = build_threshold_alert_above_strings(the_expected_value-3)
    p=subprocess.Popen(
        the_plugin_path
        + " -H localhost:1234 -t '" + the_check_type + "'"
        + " -c " + critical_thres 
